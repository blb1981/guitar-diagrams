...
var
  ...
  fontSizeForTitle = aboveTopNutYRectPosition * .6, //in pixels
  ...
  fontSizeForBrand = 16,
	fretMarkerDotSize = distanceBetweenVerticalLines*.2
  ;//end settings
...
ctx.arc(markerX[3], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[5], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[7], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[9], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[15], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[17], marginTop + (guitarHeight/2), fretMarkerDotSize, 0,2*Math.PI);
ctx.fill();
ctx.closePath();
...
ctx.beginPath();
ctx.fillStyle = "lightgrey";
ctx.arc(markerX[12], marginTop + (guitarHeight*.28), fretMarkerDotSize, 0,2*Math.PI);
ctx.arc(markerX[12], marginTop + (guitarHeight*.72), fretMarkerDotSize, 0,2*Math.PI);
ctx.fill();
ctx.closePath();
...
function printSubtitle(t) {
  ...
  ctx.beginPath();
  ctx.fillStyle = 'white';
  ctx.rect(1, aboveTopNutYRectPosition-15, canvasWidth-2, marginTop-aboveTopNutYRectPosition-1);
  ctx.fill();
  ctx.closePath();
